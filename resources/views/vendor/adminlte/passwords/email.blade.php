...
@section('body')
    <div class="login-box">
        <div class="login-logo">
            <img src="/storage/images/logo-usina.png" alt="Usina Santo Ângelo | Portal do Colaborador" width="150" >
        </div>
        <div class="login-logo">
        ...
        <div class="card">
            <div class="card-body login-card-body">
                ...
                @if ( count($errors) > 0 && $errors->has('g-recaptcha-response') )
                ...
                <p class="mt-2 mb-1 text-center">
                    <a href="{{ $login_url }}">
                        {{ __('adminlte::adminlte.back_to_login') }}
                    </a>
                </p>
            </div>
        </div>
